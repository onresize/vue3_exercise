  ...
  function o(t) {
    ...
    return (
      (o = function (t) {
        ...
        return (a.prototype = Object.create(t.prototype, { constructor: { value: a, enumerable: !1, writable: !0, configurable: !0 } })), r(a, t);
      }),
      o(t)
    );
  }
  ...
  (l.prototype.initialize = function () {
    ...
    (l.prototype.compileLinearInterpolation = function (t) {
      ...
      if (e % this.channels == 0) {
        if (e > 0) {
          for (; a < 1; a += o) for (s = 1 - (f = a % 1), r = 0; r < this.channels; ++r) l[u++] = this.lastOutput[r] * s + t[r] * f;
          for (a--, e -= this.channels, n = Math.floor(a) * this.channels; u < i && n < e; ) {
            for (s = 1 - (f = a % 1), r = 0; r < this.channels; ++r) l[u++] = t[n + r] * s + t[n + this.channels + r] * f;
        ...
        (t.port.onmessage = function (t) {
          ...
          if ((console.log("type", n), "init" === n)) {
            var o = i.frameSize,
              ...
              s = i.arrayBufferType,
              f = i.fromSampleRate;
            return (e.frameSize = o * Math.floor(f / a)), (e.resampler = new l(f, a, 1)), (e.frameBuffer = []), void (e.arrayBufferType = s);
          }
          "stop" === n && (e.port.postMessage({ frameBuffer: e.transData(e.frameBuffer), isLastFrame: !0 }), (e.frameBuffer = []));
        }),
        t
      );
    }
          ...
          value: function (t) {
            ...
            return this.frameSize
              ? ((e = this.frameBuffer).push.apply(e, f(r)),
                this.frameBuffer.length >= this.frameSize && (this.port.postMessage({ frameBuffer: this.transData(this.frameBuffer), isLastFrame: !1 }), (this.frameBuffer = [])),
                !0)
          ...
          value: function (t) {
            return (
              "short16" === this.arrayBufferType &&
                (t = (function (t) {
                  for (var e = new ArrayBuffer(2 * t.length), r = new DataView(e), n = 0, i = 0; i < t.length; i += 1, n += 2) {
