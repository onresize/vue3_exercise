    ...
    function u(u) {
      return function (s) {
        return (function (u) {
          ...
          for (; a && ((a = 0), u[0] && (i = 0)), i; )
            try {
              if (((o = 1), r && (n = 2 & u[0] ? r.return : u[0] ? r.throw || ((n = r.return) && n.call(r), 0) : r.next) && !(n = n.call(r, u[1])).done)) return n;
  ...
  function n(r, n) {
    return e(this, void 0, void 0, function () {
      return t(this, function (e) {
        switch (e.label) {
          case 0:
            return o ? [4, r.audioWorklet.addModule("".concat(n, "/processor.worklet.js"))] : [3, 2];
          case 1:
            ...
            switch (t.label) {
              ...
              case 1:
                return (
                  ...
                  (d = (function (e, t) {
                    var o;
                    try {
                      (o = new (window.AudioContext || window.webkitAudioContext)({ sampleRate: t })).createMediaStreamSource(e);
                    } catch (t) {
                      (o = new (window.AudioContext || window.webkitAudioContext)()).createMediaStreamSource(e);
                    }
                    return o;
                  })(a, u)),
                  (this.audioContext = d),
              ...
              case 2:
                return (
                  (l = t.sent()),
                  (this.audioWorklet = l),
                  l.port.postMessage({ type: "init", data: { frameSize: s, toSampleRate: u || d.sampleRate, fromSampleRate: d.sampleRate, arrayBufferType: c || "short16" } }),
                  (l.port.onmessage = function (t) {
                    s && e.onFrameRecorded && e.onFrameRecorded(t.data),
                      e.onStop &&
                        ...
                        t.data.isLastFrame && !o && (null == l ? void 0 : l.port).terminate(),
                        t.data.isLastFrame && e.onStop(e.audioBuffers));
                  }),
                  o
                    ? f.connect(l)
                    : (((p = d.createScriptProcessor(0, 1, 1)).onaudioprocess = function (e) {
                        l.port.postMessage({ type: "message", data: e.inputBuffer.getChannelData(0) });
                      }),
                      f.connect(p),
