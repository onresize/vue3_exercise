<template>
  <div>
    <h2>
      ...
      <el-tag
        class="bg-pink ft-22 h-30 ft-white"
      >
    ...
    <h2>
      ...
      >
      <div>
        <h4 class="ft-bold">注意下面两个库的版本、如果版本太高会导致上面的报错、正常CompotitionAPI使用修改语言会不正常、大坑</h4>
  ...
  <el-button @click="changeLocale"
    >切换语言:当前({{ locale == "en" ? "English" : "中文" }})</el-button
  >
</template>
