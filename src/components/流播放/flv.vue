<template>
  <div class="box">
    ...
    <el-dialog v-model="state.visible" title="监控实时画面" width="840px" class="dialog_box" :before-close="closeDiag">
      <FlvVideo v-if="state.FlvUrl" ref="FlvVideoRef" :taskInfo="{ FlvUrl: state.FlvUrl, id: state.id }"
        :style="{ height: '474px' }" class="video_body">
      </FlvVideo>
      <template #footer>
