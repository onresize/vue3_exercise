  ...
  <el-card class="mixinHeight">
    ...
    <el-collapse v-model="activeNames">
      <el-collapse-item title="跨域问题" name="2">
        <el-card>
          <el-link href="https://blog.csdn.net/weixin_46684391/article/details/130821540" style="color: #409eff"> CSDN参考 </el-link>
          <h3>同源策略：客户端基本安全要求，需要同时满足：协议、域名、端口都得相同</h3>
          <span> 注：http://127.0.0.1:7001 与 http://localhost:7001 域名不同，跨域了 </span>
          <h3>受同源限制：动态数据</h3>
          ...
          <span style="color: red"> 关于谷歌浏览器关闭跨域模式.bat文件代码：桌面新建.txt文件、cd后面是chrome.exe的C盘安装路径、添加代码后把txt后缀改成bat </span>
          <pre>
